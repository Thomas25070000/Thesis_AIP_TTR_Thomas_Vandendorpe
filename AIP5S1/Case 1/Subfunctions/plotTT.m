function [line, blocks] = plotTT(timetable, blocksections, settings, type, include_blocks, firstTime)
...
createTitle = [settings.general.caseName ' ' settings.general.subName ...
                    ' original'];
title('Infeasible timetable during busiest hour on section A in case of a disruption on the lower track');

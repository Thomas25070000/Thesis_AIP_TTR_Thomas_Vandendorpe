function [line, blocks] = plotTT_2(timetable, blocksections, settings, type, include_blocks, firstTime)

% Keep only the rows with '02' or '12' in the 'direction' column
direction_filter = (timetable.direction == 02) | (timetable.direction == 12);

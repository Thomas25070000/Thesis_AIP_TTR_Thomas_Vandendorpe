...
if ~isempty(delays_nocancel)
    ...
    delays_dir02 = delays_nocancel(direction_nocancel == 2);
    delays_dir03 = delays_nocancel(direction_nocancel == 3);
    ...
    delays_dir12 = delays_nocancel(direction_nocancel == 12);
    delays_dir13 = delays_nocancel(direction_nocancel == 13);
...
if settings.deviation.available
    deviated_dir0 = deviated(direction == 2 || direction == 3);
    deviated_dir1 = deviated(direction == 12 || direction == 13);
    ...
    for cc = 1:length(deviated)
        if deviated(cc) == 1
            ...
            if direction(cc) == 2 || direction(cc) == 3

...
runningtimes.L1.disrupted = determineRunningTime(blocksections, blockSpeed, acc, decc, buffer_factor, direction);
...
runningtimes.L0.disrupted = determineRunningTime(blocksections, blockSpeed, acc, decc, buffer_factor, direction);
